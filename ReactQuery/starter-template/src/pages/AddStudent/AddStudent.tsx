...
export default function AddStudent() {
  ...
  useEffect(() => {
    if (studentQuery.data) {
      setFormState(studentQuery.data)
    }
  }, [studentQuery.data])
        ...
        <div className='grid md:grid-cols-2 md:gap-6'>
          <div className='group relative z-0 mb-6 w-full'>
            <input
              ...
              name='first_name'
              id='first_name'
              className='dark:border-gray-60 peer block w-full appearance-none border-0 border-b-2 border-gray-300 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0 dark:focus:border-blue-500'
              placeholder=' '
